...
-(NSFetchedResultsController *)fetchedResultsController{
    if(!_fetchedResultsController){
        ...
        if(self.clone){
            ...
            request.predicate = [NSPredicate predicateWithFormat:@"clone == %@", self.clone];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(self.clone){
        ...
        cell.detailTextLabel.text = [NSString stringWithFormat:@"Ordered: %@", lot.lotOrderDate];
    }else{
        Clone *clone = [_fetchedResultsController objectAtIndexPath:indexPath];
        ZCloneSpeciesProtein *speciesProtein = (ZCloneSpeciesProtein *)clone.cloneSpeciesProteins.allObjects.lastObject;
        cell.textLabel.text = [NSString stringWithFormat:@"%@ - %@ (%@)", [speciesProtein.speciesProtein protein].proName, clone.cloName, speciesProtein.speciesProtein.species.spcName];
    }
    return cell;
}
