...
- (IBAction)create:(UIButton *)sender {
    ...
    if(message){
        [General showOKAlertWithTitle:message andMessage:nil];
        return;
    }
    ...
    if(check.count > 0){
        [General showOKAlertWithTitle:@"Protein exists" andMessage:@"This protein already exists in the database, make sure is a different one and then use a different name"];
        return;
    }
