...
-(void)noInternetConnection{
    [General showOKAlertWithTitle:@"Error" andMessage:@"You are not connected to internet"];
}

-(void)errorInternetConnection{
    [General showOKAlertWithTitle:@"Error" andMessage:@"There was an error while processing the connection request"];
}
