...
-(void)setPaso:(NSDictionary *)paso{
    ...
    float height = [General calculateHeightedLabelForLabelWithText:_pasoTexto.text andWidth:self.pasoTexto.bounds.size.width andFontSize:17];
    self.pasoTexto.numberOfLines = 0;
    self.pasoTexto.bounds = CGRectMake(0, 0, self.pasoTexto.bounds.size.width, height + 18);
