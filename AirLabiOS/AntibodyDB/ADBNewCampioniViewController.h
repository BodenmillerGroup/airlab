...
@interface ADBNewCampioniViewController : ADBMasterViewController <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
@property (weak, nonatomic) IBOutlet UIButton *objectPicture;
